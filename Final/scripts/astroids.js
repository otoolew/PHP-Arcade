...
var graphicAssets = {
    ship: {URL: 'images/astroids/ship.png', name: 'ship'},
    bullet: {URL: 'images/astroids/laser.png', name: 'bullet'},
    asteroidLarge: {URL: 'images/astroids/asteroidLarge.png', name: 'asteroidLarge'},
    asteroidMedium: {URL: 'images/astroids/asteroidMedium.png', name: 'asteroidMedium'},
    asteroidSmall: {URL: 'images/astroids/asteroidSmall.png', name: 'asteroidSmall'},
    background: {URL: 'images/astroids/astroids_background.png', name: 'background'},
    explosionLarge: {URL: 'images/astroids/explosionLarge.png', name: 'explosionLarge', width: 64, height: 64, frames: 8},
    explosionMedium: {URL: 'images/astroids/explosionMedium.png', name: 'explosionMedium', width: 58, height: 58, frames: 8},
    explosionSmall: {URL: 'images/astroids/explosionSmall.png', name: 'explosionSmall', width: 41, height: 41, frames: 8},
};
...
var soundAssets = {
    fire: {URL: ['audio/astroids/fire.m4a', 'audio/astroids/fire.ogg'], name: 'fire'},
    destroyed: {URL: ['audio/astroids/destroyed.m4a', 'audio/astroids/destroyed.ogg'], name: 'destroyed'},
};
...
gameState.prototype = {
    ...
    endGame: function () {
        document.getElementsByName("score").value = this.score;
        document.getElementById("score").value = this.score;
        document.getElementById("myForm1").submit();
        header('Location: astroids.php');

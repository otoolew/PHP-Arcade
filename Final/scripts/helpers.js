 ...
 * @param {number} ax object a: x coordinate
 * @param {number} ay object a: y coordinate
 * @param {number} aw object a: width
 * @param {number} ah object a: height
 * @param {number} bx object b: x coordinate
 * @param {number} by object b: y coordinate
 * @param {number} bw object b: width
 * @param {number} bh object b: height
 ...
 * @param {string} color hex-color of bullet
 */
function Bomb(x, y, vely, w, h, color) {
    this.x = x;
    this.y = y;
    this.vely = vely;
    this.width = w;
...
/**
 * Draw a bomb instance to the canvas
 * @param  {Bomb} bomb to draw
 */
Screen.prototype.drawBomb = function (bomb) {
    // set the current fillstyle and draw bullet
